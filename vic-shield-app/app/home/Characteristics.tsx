  ...
  return (
    <Container>
      <section className="flex flex-col px-6 md:px-8 gap-4 pb-6 md:pb-8">
        ...
        {/* contract */}
        <div className="card flex flex-col gap-2 md:gap-3 items-center p-6 md:p-8 bg-base-300 text-center text-base md:text-xl">
          <img
            src={CT}
            alt="contract"
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-y-6 md:gap-y-8 gap-x-3 md:gap-x-4">
          {/* no gas */}
          <div className="card flex-col items-center text-center p-6 md:p-8 bg-base-300">
            <img
              src={LIGHT}
              className="w-1/3 md:w-40 h-auto object-contain"
              alt="zero gas"
